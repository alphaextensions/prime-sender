  ...
  return (
    ...
    >
      <div
        className={`relative`}
      >
        <div to="/" className="py-6 px-8 text-center">
          <Typography
            variant="h6"
        ...
        <IconButton
          ...
          size="sm"
          ripple={false}
          className="absolute right-0 top-0 grid rounded-br-none rounded-tl-none xl:hidden border-none"
          onClick={() => setOpenSidenav(dispatch, false)}
        >
          <IoClose strokeWidth={2.5} className="h-5 w-5 text-white" />
        </IconButton>
      </div>
      <div className="m-4">
