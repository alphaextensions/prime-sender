...
const Pricing = () => {
  ...
  return (
    <>
      <HelmetHeader
        title={'Pricing | Message Broadcaster - Best Web Sender Extension'}
        description={'Pricing for Message Broadcaster, "Explore the future of messaging with our WhatsApp Sender Extension. Maximize productivity, enhance convenience, and simplify your communication tasks. Get started now!"'}
        keywords={'pricing, message broadcaster pricing, affordable pricing, Simple, cheap, message broadcaster pricing plans'}
      />
