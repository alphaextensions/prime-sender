...
const renderHTML = (htmlString) => {
  const sanitizedHTML = new DOMParser().parseFromString(htmlString, 'text/html');
  return <>{Array.from(sanitizedHTML.body.childNodes)}</>;
};
